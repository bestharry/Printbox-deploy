                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-md-6">
                            ...
                            <p className="text-muted">
                                Nourish your skin with radiant hydration. Our skincare essentials are crafted with premium ingredients to
                                restore balance, enhance glow, and keep your complexion healthy every day. Experience the perfect blend of
                                nourishment and luxury for a naturally luminous look.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="row align-items-center flex-md-row-reverse">
                        ...
                        <div className="col-md-6">
                            ...
                            <p className="text-muted">
                                We believe in healthy, radiant skin for everyone. Our products are thoughtfully crafted with high-quality
                                ingredients to nourish, protect, and enhance your natural glow—because confidence starts with great skin.
                ...
                <div className="container py-5 text-center">
                    ...
                    <div className="row justify-content-center align-items-center mt-5 gy-4">
                        <div
                            ...
                            onClick={() => setQuote('“ Quality products at great prices, delivering the perfect mix of affordability and excellence. Each item ensures great value for money.”')}
                            style={{ cursor: 'pointer' }}
                        >
                            <img src={client1} alt="Goodness" className="img-fluid" style={{ maxHeight: '60px', objectFit: 'contain', }} />
                        </div>

                        <div
                            className="col-6 col-sm-4 col-md-2 d-flex justify-content-center brands-img"
                            onClick={() => setQuote('“Great beauty service! The experience was truly amazing, and I feel more confident and radiant with my beauty after every visit”')}
                            style={{ cursor: 'pointer' }}
                        >
                            <img src={client2} alt="Grand Golden Gallery" className="img-fluid" style={{ maxHeight: '60px', objectFit: 'contain' }} />
                        </div>

                        <div
                            className="col-6 col-sm-4 col-md-2 d-flex justify-content-center brands-img"
                            onClick={() => setQuote('“ Amazing product. The results are so transformative in texture and my face feels plump and healthy. Highly recommend! ”')}
                            style={{ cursor: 'pointer' }}
                        >
                            <img src={client3} alt="Parker & Co." className="img-fluid" style={{ maxHeight: '60px', objectFit: 'contain' }} />
                        </div>
                        ...
                        <div
                            ...
                            style={{ cursor: 'pointer' }}
                        >
                            <img src={client4} alt="The Beast" className="img-fluid" style={{ maxHeight: '60px', objectFit: 'contain' }} />
                        </div>
                        ...
                        <div
                            ...
                            style={{ cursor: 'pointer' }}
                        >
                            <img src={client5} alt="The Hayden" className="img-fluid" style={{ maxHeight: '60px', objectFit: 'contain' }} />
                        </div>
                        ...
                        <div
                            ...
                            style={{ cursor: 'pointer' }}
                        >
                            <img src={client6} alt="Good Mood" className="img-fluid" style={{ maxHeight: '60px', objectFit: 'contain' }} />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="team-section">
                ...
                <div className="team-row">
                    ...
                    <div className="team-member">
                        ...
                        <h3 className="team-name">Valeriia Nadopta</h3>
